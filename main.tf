...
resource "azurerm_virtual_machine" "cisvm" {
  ...
  storage_image_reference {
    ...
    offer     = "cis-windows-server"      # example: CIS Windows Server 2019 Level 1 Generation 2 offer
    sku       = "cis-windows-server2019-l1-gen2"                # SKU for the level 1 gen 2 image
    version   = "latest"
  }

  # Required plan block for marketplace images with licensing/terms
  plan {
    name      = "cis-windows-server2019-l1-gen2"
